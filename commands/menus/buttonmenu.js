...
export default {
    ...
    async execute(sock, m, args, PREFIX) {
        try {
            ...
            const categoryMap = {
                'downloaders': ['play', 'song', 'video', 'tiktok', 'instagram', 'facebook', 'twitter', 'tgsticker', 'apk', 'mediafire', 'downloadurl', 'gdrive', 'spotify', 'soundcloud', 'pinterest', 'reddit', 'snack', 'likee', 'capcut'],

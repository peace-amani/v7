...
import { xwolfSearch, streamXWolf, xwolfDownloadVideo } from '../../lib/xwolfApi.js';
...
export default {
  ...
  async execute(sock, m, args, prefix) {
    ...
    try {
      ...
      let videoBuffer = await xwolfDownloadVideo(searchQuery);
      if (!videoBuffer) videoBuffer = await streamXWolf(searchQuery, 'mp4', 150000);
